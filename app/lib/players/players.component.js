System.register(['angular2/core', './player.component', './player.interface'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, player_component_1, player_interface_1;
    ...
    return {
        setters:[
            ...
            function (player_interface_1_1) {
                player_interface_1 = player_interface_1_1;
            }],
        execute: function() {
            PlayersComponent = (function () {
                ...
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', player_interface_1.Player)
